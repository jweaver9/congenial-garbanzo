...
export async function handleOpenAIRequest(messages: any[], openaiClient: OpenAI) {
...
export async function handleAnthropicRequest(messages: any[], anthropicClient: Anthropic) {
